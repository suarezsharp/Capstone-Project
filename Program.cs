...
namespace Capstone_Project_Console
{
    ...
    //************************
    {
        static void Main(string[] args)
        {
            ...
            DisplayTitleCard();
            isVictorious = DoBattleSequence(party);
            DisplayExitCard(isVictorious);
        }

        static bool DoBattleSequence(List<FriendlyCharacter> party)
        {
            ...
            if (enemyParty[0].Status == EnemyCharacter.StatusEffect.KO
                ...
                && enemyParty[2].Status == EnemyCharacter.StatusEffect.KO)
            {
                Console.WriteLine();
        ...
        static void DisplayTitleCard()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("\t\tThe people in the countryside are being terrorized by a band of snakes!");
            Console.WriteLine("\t\tUse your might and magic to defeat them.");
            Console.WriteLine();
            Console.WriteLine("\t\tPress any key to start.");
            Console.ReadKey();
        }

        static void DisplayExitCard(bool isVictorious)
        {
            Console.Clear();
            Console.WriteLine("\t\t RPG Battle Simulator");
            Console.WriteLine();
            if (isVictorious)
            {
                Console.WriteLine("\t\tYou defeated all the snakes! The kingdom is safe for now.");
                Console.WriteLine();
            ...
            {
                Console.WriteLine("\t\tYou fell to the might of the snakes. The kingdom shortly became corrupted by lizardfolk.");
                Console.WriteLine();
                Console.WriteLine("\t\tPress any key to exit.");
                Console.ReadKey();
            }
